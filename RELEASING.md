...
- [ ] Test the published-shape locally:
  ```bash
  pnpm pack --pack-destination /tmp     # in packages/sdk and packages/create-arckit-app
...
| `create-arckit-app-vX.Y.Z` | `create-arckit-app` to npm |
...
- [ ] Verify install: `npm install arckit-sdk` / `pip install arckit-sdk` / `npx create-arckit-app demo`
